                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-3" style="text-align-last: center">
                                <p>Imagen</p>
                                <img  id="imagen" src="{{asset('storage/noticias/'.$noticia->ruta_logo)}}" alt="" style="height:100px;">
                            </div>
                            <div class="col-sm-5">
                                <label for="">Reemplazar Imagen</label>
                                <input type="file" name="ruta_logo" id="ruta_logo" value="{{$noticia->ruta_logo}}" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
